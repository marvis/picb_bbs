...
Latest File Update: 2010-Jul-14
*/
...
$addFieldsGen=array($dbUserSheme['user_icq'][1], $dbUserSheme['user_website'][1], $dbUserSheme['user_occ'][1], $dbUserSheme['user_from'][1], $dbUserSheme['user_interest'][1], $dbUserSheme['num_topics'][1], $dbUserSheme['num_posts'][1]);
