...
file for more details. Copyright (C) 2004-2010 Paul Puzyrev, Sergei Larionov. www.minibb.com
Latest File Update: 2010-Sep-09
*/
...
<a href="$main_url" target="_blank"><img src="{$main_url}/img/minibb.gif" alt="{$sitename} {$l_poweredBy} {$software} miniBB &reg;" title="{$sitename} {$l_poweredBy} {$software} miniBB &reg;" /></a>
out;
